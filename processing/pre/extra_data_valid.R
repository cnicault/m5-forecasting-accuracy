...
sales <- fread(here::here("data", "sales_train_validation.csv"))
...
save(full_item_id, full_dept_id, full_cat_id, full_state_item, full_state_dept, full_state_cat, full_store_id, full_store_dept, price_mom_m, price_mom_y, prices_change, file = here::here("wrk", "extra_data_valid.RData"))
