#
# Title  : M5 competition - full model, data split by store for a state, weekly forecast
...
# To predict for one store instead of all the store for the state
# comment the for loop, and un-comment the following line
# store_id <- "CA_2"
stores <- stores_list()
